...
static_assert(sizeof(block_q4_1) == 2 * sizeof(uint16_t) + QK4_1 / 2, "wrong q4_1 block size/padding");
...
static_assert(sizeof(block_q5_0) == sizeof(uint16_t) + sizeof(uint32_t) + QK5_0 / 2, "wrong q5_0 block size/padding");
...
static_assert(sizeof(block_q5_1) == 2 * sizeof(uint16_t) + sizeof(uint32_t) + QK5_1 / 2, "wrong q5_1 block size/padding");
...
static_assert(sizeof(block_iq4_nl) == sizeof(uint16_t) + QK4_NL / 2, "wrong iq4_nl block size/padding");
