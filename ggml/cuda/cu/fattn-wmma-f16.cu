...
void ggml_cuda_flash_attn_ext_wmma_f16_case(const flash_attn_ext_context& ctx) {
    ...
    launch_fattn<D, cols_per_block, 1, -1>(ctx, fattn_kernel, nwarps, 0, FATTN_KQ_STRIDE, true, true, false, warp_size);
}
...
void ggml_cuda_flash_attn_ext_wmma_f16(const flash_attn_ext_context& ctx) {
    ...
    if (prec != GGML_PREC_DEFAULT) {
        if (ctx.Q.ne1 <= 32 || ctx.Q.ne0 > 128) {
            ...
            case 64:
                ...
                break;
            case 80:
                ggml_cuda_flash_attn_ext_wmma_f16_case< 80, cols_per_block, float>(ctx);
                break;
            case 96:
                ggml_cuda_flash_attn_ext_wmma_f16_case< 96, cols_per_block, float>(ctx);
                break;
            case 112:
                ggml_cuda_flash_attn_ext_wmma_f16_case<112, cols_per_block, float>(ctx);
                break;
            case 128:
                ggml_cuda_flash_attn_ext_wmma_f16_case<128, cols_per_block, float>(ctx);
                break;
            case 256:
                ggml_cuda_flash_attn_ext_wmma_f16_case<256, cols_per_block, float>(ctx);
                break;
            default:
    ...
    if (ctx.Q.ne1 <= 32) {
        ...
        case 64:
            ...
            break;
        case 80:
            ggml_cuda_flash_attn_ext_wmma_f16_case< 80, cols_per_block, half>(ctx);
            break;
        case 96:
            ggml_cuda_flash_attn_ext_wmma_f16_case< 96, cols_per_block, half>(ctx);
            break;
        case 112:
            ggml_cuda_flash_attn_ext_wmma_f16_case<112, cols_per_block, half>(ctx);
            break;
        case 128:
            ggml_cuda_flash_attn_ext_wmma_f16_case<128, cols_per_block, half>(ctx);
            break;
