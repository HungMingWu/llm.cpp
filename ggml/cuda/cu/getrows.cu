...
void get_rows_cuda(const get_row_context* ctx, cudaStream_t stream)
{
    ...
    case GGML_TYPE_F32:
        ...
        break;
    case GGML_TYPE_Q4_0:
        get_rows_cuda<QK4_0, QR4_0, dequantize_q4_0>(ctx, stream);
        break;
    case GGML_TYPE_Q4_1:
        get_rows_cuda<QK4_1, QR4_1, dequantize_q4_1>(ctx, stream);
        break;
    case GGML_TYPE_Q5_0:
        get_rows_cuda<QK5_0, QR5_0, dequantize_q5_0>(ctx, stream);
        break;
    case GGML_TYPE_Q5_1:
        get_rows_cuda<QK5_1, QR5_1, dequantize_q5_1>(ctx, stream);
        break;
    case GGML_TYPE_Q8_0:
        get_rows_cuda<QK8_0, QR8_0, dequantize_q8_0>(ctx, stream);
        break;
    default:
        // TODO: k-quants
