...
template <size_t vdr>
static __device__ __forceinline__  int calc_sum(const int *v, const int *u)
{
    int sumi = 0;
#pragma unroll
    for (int i = 0; i < vdr; ++i) {
...
template <size_t vdr> static __device__ __forceinline__ float vec_dot_q4_0_q8_1_impl(
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q1_0 * __restrict__ bq1_0, const block_q8_1 * __restrict__ bq8_1, const int & iqs) {
    ...
    const float     d1 = std::bit_cast<half>(bq1_0->d);;
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q2_0* __restrict__ bq2_0, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
    ...
    const float     d2 = std::bit_cast<half>(bq2_0->d);
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q4_0* __restrict__ bq4_0, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
template <size_t vdr> static __device__ __forceinline__ float vec_dot_q4_1_q8_1_impl(
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q4_1* __restrict__ bq4_1, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
template <size_t vdr>
static __device__ __forceinline__ int calc_sum(
    const int (&vl)[vdr],
    const int (&vh)[vdr],
    const int (&u)[2 * vdr])
{
...
template <size_t vdr> static __device__ __forceinline__ float vec_dot_q5_0_q8_1_impl(
    const int (&vl)[vdr], const int (&vh)[vdr], const int(&u)[2 * vdr], const float& d5, const half2& ds8) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q5_0* __restrict__ bq5_0, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
template <size_t vdr> static __device__ __forceinline__ float vec_dot_q5_1_q8_1_impl(
    const int (&vl)[vdr], const int (&vh)[vdr], const int (&u)[2 * vdr], const half2& dm5, const half2& ds8) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q5_1* __restrict__ bq5_1, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q8_0* __restrict__ bq8_0, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
                                        const block_nvfp4* __restrict__ bq4,
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q2_K* __restrict__ bq2_K, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
#pragma unroll
    ...
    return vec_dot_q2_K_q8_1_impl_mmvq(v, u, scales, __tohalf2(bq2_K->dm), d8);
}
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q3_K* __restrict__ bq3_K, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q4_K* __restrict__ bq4_K, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
    ...
    return vec_dot_q4_K_q8_1_impl_vmmq(v, u, sc, m, __tohalf2(bq4_K->dm), d8);
}
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q5_K* __restrict__ bq5_K, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
#pragma unroll
    ...
    return vec_dot_q5_K_q8_1_impl_vmmq(vl, vh, u, sc, m, __tohalf2(bq5_K->dm), d8);
}
...
static __device__ __forceinline__ float vec_dot_q(
    const block_q6_K* __restrict__ bq6_K, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq2_xxs* __restrict__ bq2, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq4_xs* __restrict__ bq4, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq2_xs* __restrict__ bq2, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq2_s* __restrict__ bq2, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq1_s* __restrict__ bq1, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq3_xxs* __restrict__ bq3, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq1_m* __restrict__ bq1, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
...
#pragma unroll
    ...
    const float d = __half2float(std::bit_cast<half>(scale)) * __low2float(bq8_1[iqs].ds);
...
static __device__ __forceinline__ float vec_dot_q(
    const block_iq4_nl* __restrict__ bq4, const block_q8_1* __restrict__ bq8_1, const int& iqs) {
