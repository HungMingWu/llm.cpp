...
static __global__ void quantize_q8_1(
    ...
    std::array<half, 2> ds{ d, sum };
    y[ib].ds = std::bit_cast<uint32_t>(ds);
}
...
static __global__ void quantize_mmq_q8_1(
    ...
    const int64_t ne00, const int64_t s01, const int64_t s02, const int64_t s03,
    const int64_t ne0, const int ne1, const int ne2, [[maybe_unused]] const int n_expert_used) {
...
void quantize_scatter_mmq_q8_1_cuda(
    const float* x, const int32_t* ids_src1_inv, void* vy, const internal::ggml_type type_src0,
...
static __global__ void quantize_mmq_mxfp4(const float* __restrict__ x,
    ...
    const int     ne1,
    const int     ne2,
    [[maybe_unused]] const int     n_expert_used) {
...
void quantize_scatter_mmq_fp4_cuda(
        const float * x, const int32_t * ids_src1_inv, void * vy, float * scale, const internal::ggml_type type_src0, const bool use_aligned_float8,
        const int64_t ne00, const int64_t stride_token, const int64_t ne0,
        const int64_t n_tokens, const int64_t nrows_dst, const int n_expert_used, cudaStream_t stream) {
    GGML_ASSERT(ne0 > 0);
    if (type_src0 == internal::GGML_TYPE_NVFP4) {
        GGML_ASSERT(scale);
        ...
        GGML_ASSERT(type_src0 == internal:GGML_TYPE_MXFP4);
        constexpr int nwarps = 8;
        constexpr int vals_per_block = nwarps * 2 * block_mxfp4::block_size;
...
void quantize_mmq_fp4_cuda(
        const float * x, const int32_t * ids, void * vy, float * scale, const internal::ggml_type type_src0, const bool use_aligned_float8,
        const int64_t ne00, const int64_t s01, const int64_t s02, const int64_t s03,
        const int64_t ne0, const int64_t ne1, const int64_t ne2, const int64_t ne3, cudaStream_t stream) {
    ...
    if (type_src0 == internal::GGML_TYPE_NVFP4) {
        ...
        GGML_ASSERT(ne0 % (2 * block_mxfp4::block_size) == 0);

        constexpr int nwarps = 8;
        constexpr int vals_per_warp  = 2 * block_mxfp4::block_size;
