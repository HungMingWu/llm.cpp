...
bool ggml_cuda_should_use_mmf(enum ggml_type type, size_t type_size, int cc, int warp_size, const int64_t* src0_ne, int64_t ne11) {
...
void mul_mat_f_cuda(const mul_mat_f_context* ctx, cudaStream_t stream)
{
    ...
    case GGML_TYPE_F32: {
        ...
        mul_mat_f_switch_cols_per_block(
            ...
            ctx->ne01, ctx->ncols_dst, ctx->s01 / vals_per_T, ctx->s11 / vals_per_T, ctx->s1,
            ctx->ne02, ctx->nchannels_y, ctx->nchannels_dst, ctx->s02 / vals_per_T,
