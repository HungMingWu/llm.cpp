...
export
{
	...
	using ggml_e8m0_t = strong_type<uint8_t, struct e8m0>;
	using ggml_ue4m3_t = strong_type<uint8_t, struct ue4m3>;
	...
	ggml_fp32_t toFloat32(ggml_e8m0_t x);
	...
	ggml_fp32_t toFloat32(ggml_ue4m3_t x);
}
