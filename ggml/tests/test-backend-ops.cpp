...
struct test_get_rows_back : public test_case {
    ...
    std::string vars() override {
        return std::format("type={},n={},m={},r={},b={},v={}",
            type, toString(n), toString(m), r, b, static_cast<int>(v));
    }
...
struct test_im2col : public test_case {
    ...
    std::string vars() override {
        return std::format("type_input={},type_kernel={},dst_type={},ne_input={},ne_kernel={},s0={}"
            ...
            toString(ne_input), toString(ne_kernel), s0, s1, p0, p1, d0, d1, static_cast<int>(is_2D));
    }
...
struct test_upscale : public test_case {
    ...
    std::string vars() override {
        return std::format("type={},ne={},scale_factor={},transpose={}",
            type, ne, scale_factor, static_cast<int>(transpose));
    }
...
struct test_upscale_ext : public test_case {
    ...
    std::string vars() override {
        return std::format("type={},ne={},ne_tgt={}", type, ne, ne_tgt);
    }
...
struct test_flash_attn_ext : public test_case {
    ...
    std::string vars() override {
        return std::format("hsk={},hsv={},nh={},nr={},kv={},nb={},mask={},max_bias={:6f},"
            "logit_softcap={:6f},type_KV={},permute={}", hsk, hsv,
            nh, nr, kv, nb, static_cast<int>(mask), max_bias, logit_softcap, type_KV, toString(permute));
    }
