...
struct test_case {
    ...
    test_status_t eval(ggml_backend* backend1,
        ...
        if (!supported) {
            ...
            test_result result(backend1->get_name(), current_op_name, vars(), "test",
...
struct test_set_rows : public test_case {
    ...
    std::string vars() override {
        return std::format("type={},type_idx={},ne={},nr23={},r={},v={}",
            type, type_idx, ne, nr23, r, static_cast<int>(v));
    }
...
struct test_conv_2d_dw : public test_case {
    ...
    std::string vars() override {
        return std::format("ne_input={},ne_kernel={},stride={},padding={},dilation={},cwhn={}",
            ne_input, ne_kernel, stride, padding, dilation, static_cast<int>(cwhn));
    }
...
struct test_rms_norm_mul_rope : public test_case {
    ...
    std::string vars() override {
        return std::format("ne={},eps={:6f},multi_add={},set_rows={},mode={}", ne, eps,
            static_cast<int>(multi_add), static_cast<int>(set_rows), mode);
    }
...
struct test_cpy : public test_case {
    ...
    ggml_tensor* build_graph(ggml_context* ctx) override {
        ...
        ggml_tensor* dst = ggml_new_tensor(ctx, type_dst, dst_ne);
        dst->set_name("dst");
...
struct test_cont : public test_case {
    ...
    std::string vars() override {
        return std::format("type={},ne={},use_view_slice={}", type, ne, static_cast<int>(use_view_slice));
    }
...
struct test_mul_mat : public test_case {
    ...
    std::string vars() override {
        return std::format("type_a={},type_b={},m={},n={},k={},bs={},nr={},per={},k_v={},o={}",
            type_a, type_b, m, n, k, bs, nr, per, k_v, o);
    }
...
struct test_rope : public test_case {
    ...
    std::string vars() override {
        ...
        return std::format("type={},ne_a={},n_dims={},mode={},n_ctx={},fs={:6f},ef={:6f},af={:6f},ff={},v={},inplace={}",
            type, ne_a, n_dims, mode, n_ctx, fs, ef, af, static_cast<int>(ff), static_cast<int>(v), static_cast<int>(inplace));
    }
...
struct test_mul_mat_vec_fusion : public test_case {
    ...
    std::string vars() override {
        return std::format("type={},glu_op={},m={},n={},k={},use_id={},n_mats={},n_used={},b={},with_bias={},with_gate={},batch_dims={}",
            type, glu_op, m, n, k, static_cast<int>(use_id), n_mats,
            n_used, static_cast<int>(b), static_cast<int>(with_bias), static_cast<int>(with_gate), batch_dims);
    }
...
struct test_roll : public test_case {
    ...
    std::string vars() override {
        return std::format("shift0={},shift1={},shift3={},shift4={}",
            shift0, shift1, shift3, shift4);
    }
...
struct test_flash_attn_ext : public test_case {
    ...
    std::string vars() override {
        return std::format("hsk={},hsv={},nh={},nr23={},kv={},nb={},mask={},sinks={},max_bias={:6f},"
            "logit_softcap={:6f},prec={},type_K={},type_V={},permute={}", hsk, hsv,
            nh, nr23, kv, nb, static_cast<int>(mask), static_cast<int>(sinks),
            max_bias, logit_softcap, prec, type_K, type_V, permute);
    }
    ...
    for (ggml_type type : all_types) {
        for (int b : {1, 7}) {
            for (bool v : {false, true}) {
                ...
                test_cases.emplace_back(new test_set_rows(type, GGML_TYPE_I64, { 3 * static_cast<int64_t>(ggml_blck_size(type)), 3, b, 1 }, { 2, 3, }, 2, v));
