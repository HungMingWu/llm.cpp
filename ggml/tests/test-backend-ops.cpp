...
struct test_cpy : public test_case {
    ...
    std::string vars() override {
        return std::format("type_src={},type_dst={},ne={},permute={}",
            toString(type_src), toString(type_dst), toString(ne), toString(permute));
    }
    ...
    ggml_tensor* build_graph(ggml_context* ctx) override {
        ...
        ggml_tensor* dst = ctx->create(type_dst, { src->ne[0], src->ne[1], src->ne[2], src->ne[3] });
        dst->set_name("dst");
...
struct test_mul_mat : public test_case {
    ...
    std::string vars() override {
        return std::format("type_a={},type_b={},m={},n={},k={},bs={},nr={},per={}",
            toString(type_a), toString(type_b), m, n, k, bs, nr, per);
    }
