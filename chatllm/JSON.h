 ...
 * performance fixes, documentation and bugfixes added by <giri@nwrk.biz>.
 *
 * ### Original License:
...
namespace json {
    ...
    public:
        ...
        const JSON& operator[](unsigned index) const {
            if (!IsArray()) return JSON::_null;
            if (index >= Internal.List->size()) return JSON::_null;
            return Internal.List->operator[](index);
        }
