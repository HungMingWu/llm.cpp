...
export namespace chatllm
{
    ...
    namespace ggml
    {
        ...
        ggml::tensor* group_norm(ComputeContext* ctx, ggml::tensor* a, int n_groups, float eps, bool inplace);
    ...
    public:
        ...
        Embedding(InitContext* ctx, ggml::type dtype, int num_embeddings, int embedding_dim)
            ...
            weight(ctx->new_tensor(ggml::type_fallback(dtype, embedding_dim), {
                num_embeddings + BlockParams::get_padded_embedding_num(), embedding_dim }))
        {
    ...
    public:
        ...
        ggml::tensor* forward(ComputeContext* ctx, ggml::tensor* input, ggml::tensor* selected) override;
