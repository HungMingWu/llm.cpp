...
export namespace chatllm
{
    ...
    public:
        ...
        void init(const std::map<std::string, std::string>& model_n_gpu_layers, const std::string& model_id, const int n_layers, const int n_threads, const std::string fallback_id = "any");
        void init(const std::string& gpu_cfgs, const int n_layers, const int n_threads);
