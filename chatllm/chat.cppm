...
export namespace chatllm
{
    ...
    {
    public:
        GGMLContext() : gctx_(std::make_unique< ggml_context>()) {}

        // copy constructor
        GGMLContext(const GGMLContext&) = delete;
        // move constructor
        GGMLContext(GGMLContext&& other) : gctx_(std::move(other.gctx_)) {}
        ...
        {
            gctx_ = std::move(other.gctx_);
            return *this;
        }

        ggml_context* get() const { return gctx_.get(); }
    ...
    private:
        std::unique_ptr<ggml_context> gctx_;
    };
